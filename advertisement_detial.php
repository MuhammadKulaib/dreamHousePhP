            ...
            <div class="container py-4">
                <div class="mt-4">
                    ...
                    <div class="row row-cols-4 mt-4">
                        <div style="height: 350px;background-image: url('assets/images/buildings/bedroom 6.png');background-size: contain;background-repeat: no-repeat;width: 294px;">
                            <div class=" flex justify-center items-center h-100 w-100">


                            </div>
                        </div>
                        <div style="height: 350px;background-image: url('assets/images/buildings/bedroom 8.png');background-size: contain;background-repeat: no-repeat;width: 294px;">
                            <div class=" flex justify-center items-center h-100 w-100">


                            </div>
                        </div>
                        <div style="height: 350px;background-image: url('assets/images/buildings/bedroom 9.png');background-size: contain;background-repeat: no-repeat;width: 294px;">
                            <div class=" flex justify-center items-center h-100 w-100">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex items-center justify-evenly mt-4 w-100">
                            <span class="btn-green" placeholder="" style="color: #fff !important;">سلطان الحربي</span>
                            <span class="input btn-green">0565656565</span>
